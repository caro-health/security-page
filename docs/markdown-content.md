...
Encryption in transit: All data sent to or from our infrastructure is encrypted in transit via industry best-practices using Transport Layer Security (TLS). You can see our SSLLabs report [here](https://www.ssllabs.com/ssltest/analyze.html?d=caro.health)
...
Read more about our privacy settings at [caro.health/privacy](caro.health/privacy).
...
- We use security headers to protect our users from attacks. You can check our grade on [this security scanner](https://www.sqreen.io/scan?url=https%3A%2F%2Fcaro.health).
...
You can report vulnerabilities by contacting [security@caro.health](mailto:security@caro.health). Please include a proof of concept. We will respond as quickly as possible to your submission and won’t take legal actions if you follow the rules.
